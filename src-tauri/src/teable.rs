...
const REQUIRED_FIELDS: &[RequiredField] = &[
    ...
    RequiredField { name: "Nozzle Diameter",        field_type: "number",          description: "Nozzle diameter (2, 3, or 4 mm)" },
    ...
    RequiredField { name: "Experiment Name",        field_type: "singleLineText", description: "User-defined experiment name" },
